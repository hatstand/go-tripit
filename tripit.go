...
type Response struct {
	...
	PageNum          int                       `json:"page_num,string,omitempty" xml:"page_num"`
	PageSize         int                       `json:"page_size,string,omitempty" xml:"page_size"`
	MaxPage          int                       `json:"max_page,string,omit_empty" xml:"max_page"`
